...
const typeLabel = (t) => ALERT_META[t]?.label ?? t;
const typeColor = (t, i) => ALERT_META[t]?.color ?? PALETTE[i % PALETTE.length];
...
// ─── Alerts list modal ────────────────────────────────────────────────────────
function AlertsModal({ type, alerts, onClose }) {
                  ...
                  <tr key={a.id} className="hover:bg-slate-50 transition">
                    <td className="px-4 py-2.5">
                      <span
                        ...
                        style={{
                          background: `${typeColor(a.type, 0)}1a`,
                          color: typeColor(a.type, 0),
                        }}
                      >
                        <span
                          className="w-1.5 h-1.5 rounded-full"
                          style={{ background: typeColor(a.type, 0) }}
                        />
                        {typeLabel(a.type)}
                      </span>
                    </td>
