...
function ChatbotWidget() {
  ...
  const selectOption = (opt) => {
    setMsgs((p) => [
      ...
      {
        role: "bot",
        text: `You selected **${opt}**. Conversation complete. You can close the widget.`,
      },
    ]);
    setStep(STEP.DONE);
    scroll();
...
function exportCsv(data, imei) {
  ...
  const a = Object.assign(document.createElement("a"), {
    href: url,
    download: `LiveLoad_${imei || "data"}_${Date.now()}.csv`,
  });
  a.click();
