...
const ACTIVE_STATUSES = ['In Transit', 'At Source', 'At Destination', 'Delayed', 'Scheduled'];
...
export default function TripsPage() {
  ...
  const filtered = useMemo(() => {
    ...
    const byTab = list.filter((t) =>
      tab === 'Active' ? ACTIVE_STATUSES.includes(t.status) : t.status === 'Completed'
    );
  ...
  return (
    <div>
      <PageHeader
        crumbs={['Operations', 'Trips']}
        title="Trip Dashboard"
        description="Monitor active and completed trips, assignments and live progress."
        actions={
          <>
